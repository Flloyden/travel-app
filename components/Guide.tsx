      ...
      <div className='padding-container max-container w-full pb-24'>
        ...
        <div className='flex flex-wrap justify-between gap-5 lg:gap-10'>
          ...
          <p className='regular-16 text-gray-30 xl:max-w-[520px]'>
            Only with the HiTrail application you will no longer get lost and get lost again, 
          ...
          <div className='flexBetween flex-col'>
            <div className='flex w-full flex-col'>
              <div className='flexBetween w-full'>
                ...
                <p className='bold-16 text-green-50'>49 km</p>
              </div>
              <p className='bold-20 mt-2'>Lee’s Ferry</p>
            </div>

            <div className='flex w-full flex-col'>
              <p className='regular-16 text-gray-20'>Start track</p>
              <h4 className='bold-20 mt-2 whitespace-nowrap'>Glen Canyon Dam</h4>
            </div>
          </div>
        </div>
      </div>
